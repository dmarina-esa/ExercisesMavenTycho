...
import com.gmv.tycho.example.plugin.SuperSecret;

public class View extends ViewPart {

	public static final String ID = "com.gmv.tycho.example.application.view";
	...
	public void createPartControl(Composite parent) {
		...
		SuperSecret secret = new SuperSecret("TOP SECRET");
